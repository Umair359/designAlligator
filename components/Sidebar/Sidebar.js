    ...
    <div className="overlay" ref={navbarRef}>
      ...
      <div className={"overlay-content"}>
        ...
        <Link
          href="/portfolios"
          className={
            router.pathname === "/portfolios" ? "nav-active" : "nav-link"
          }
        >
          <span className="overlay-content-number">04 - </span>Our Portfolios
        </Link>
        <a
          href="https://blog.designalligators.com/"
          className={router.pathname === "/blog" ? "nav-active" : "nav-link"}
        >
          <span className="overlay-content-number">05 - </span>Blog
        </a>
        <Link
          href="/contact-us"
          className={
